...
abstract class BaseActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 课表页的 ViewPager 页在 table 异步读完之前没有任何可渲染状态；把 fragment
        // 恢复整份丢掉，让 initView 完成后由 initViewPage 重建。不丢的话，Android 16
        // 上 onStart 会先恢复 ScheduleFragment 并在 onCreateView 读 lateinit table。
